"use client"; // Make this a client component to handle state for filters/sorts
...
export default function HomePage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        setProducts(fetchedProducts); // Initially display all products
  ...
  const filteredAndSortedProducts = useMemo(() => {
    ...
    if (sortKey) {
      ...
      // 'default' sort does not re-sort, keeps original order or previous sort state of category change
    }
